  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        // Close only via the X (or an explicit Cancel/Close button): a stray
        // click on the backdrop or an Escape keypress must not discard an open
        // form. A specific dialog can opt back into dismiss-on-outside/Escape by
        // passing its own handler (e.g. the image lightbox in attachment-grid).
